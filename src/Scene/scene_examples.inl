...
const Scene& populate_scene(unsigned index)
{
    ...
    case 0:
        Scenes::SCENE_0.add(
                ...
                ,dynamic_cast<Object*>(new Plane(Vec3d(0, 1,  0),   0.0, Materials::DIFFUSE))
                ,dynamic_cast<Object*>(new Plane(Vec3d(0, 0, -1), -10.0, Materials::DIFFUSE))

                ,dynamic_cast<Object*>(new Sphere(Vec3d(2, 1, -1.25), 1.0, Colors::PURPLE, Materials::GLASS))
                ,dynamic_cast<Object*>(new Sphere(Vec3d(0, 2,  1),    2.0, Colors::YELLOW, Materials::GLASS))
        );
