...
const Scene& populate_scene(unsigned index)
{
    ...
    case 0:
        Scenes::SCENE_0.add(
                ...
                ,dynamic_cast<Object*>(new Sphere(Vec3d( -5.0, 2.0, -1.25), 2.00, Colors::GREEN,  Materials::METAL))
                ...
                ,dynamic_cast<Object*>(new Sphere(Vec3d(  4.0, 3.0,  4.00), 3.00, Colors::RED,    Materials::METAL))
        );
